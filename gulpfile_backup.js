...
// #PICTURES
// ************************************
const IMAGES_SOURCE_PATH = './assets/img/original';
const IMAGES_DEST_PATH = './_site/img/original';
gulp.task('hello', function () {
  console.log('Hello Zell');
});
gulp.task('process-images', () => {
  gulp.src = IMAGES_SOURCE_PATH.pipe(changed(IMAGES_DEST_PATH)).pipe(task1());
});
